...
$products = [
    ...
    // Kategori Mercon
    ['id' => 3, 'name' => 'Ceker Mercon Tanpa Tulang', 'price' => 15000, 'category' => 'mercon', 'image' => 'assets/images/mercon/ceker_tnpa_tulang.png', 'description' => 'Ceker mercon tanpa tulang super pedas', 'has_variant' => true, 'variants' => [
    ...
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-md-down">
        <div class="modal-content" style="border: none; border-radius: 0;">
            ...
            <div class="modal-body" style="padding: 0; overflow-y: auto; max-height: calc(100vh - 140px);">
                ...
                <div style="padding: 16px; border-bottom: 1px solid #f0f0f0;">
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <div style="width: 48px; height: 48px; border-radius: 50%; overflow: hidden; background: white; border: 1px solid #eee;">
                        <img src="assets/images/logo.png" alt="Texcer Hot" 
                        ...
                        <button onclick="showTokoModal()" style="background: #f0f0f0; border: none; padding: 8px 16px; border-radius: 20px; font-weight: 600; color: #333;">Kunjungi</button>
                    </div>
            ...
            <!-- Tambahkan ini sebelum penutup modal-body -->
            ...
            <input type="hidden" name="variant" id="md-form-variant" value="">
            <input type="hidden" name="buy_now" id="md-buy-now" value="0">
            </form>
            ...
            <div class="modal-footer" style="border-top: 1px solid #e0e0e0; padding: 12px 16px; background: white; position: sticky; bottom: 0;">
                ...
                onclick="showTokoModal()">
                <i class="fas fa-store" style="display: block; font-size: 1.2rem;"></i>
                <span style="font-size: 0.75rem;">Toko</span>
                </button>
                <a href="https://wa.me/6281934174198?text=Halo%20Texcer%20Hot%2C%20saya%20ingin%20bertanya%20tentang%20produk%20ini!"
                target="_blank"
                class="btn btn-link" style="text-decoration: none; color: #333; padding: 8px;">
                <i class="fas fa-comment" style="display: block; font-size: 1.2rem;"></i>
                <span style="font-size: 0.75rem;">Chat</span>
                </a>
                <button type="submit" form="modalFormPesan" class="btn" 
                onclick="document.getElementById('md-buy-now').value='0'"
                style="background: #f0f0f0; border-radius: 50%; width: 48px; height: 48px; padding: 0; display: flex; align-items: center; justify-content: center; margin: 0 8px;">
                <i class="fas fa-shopping-cart" style="color: #00B14F; font-size: 1.3rem;"></i>
                </button>
               <button type="submit" form="modalFormPesan" class="btn"
               onclick="document.getElementById('md-buy-now').value='1'"
               style="background: #00B14F; color: white; border-radius: 24px; padding: 12px 32px; font-weight: 600; flex: 1; max-width: 200px;">
...
modal.addEventListener('show.bs.modal', function (event) {
    ...
    // Isi harga di Flash Sale banner & bottom bar
    var hargaFormat = 'Rp ' + parseInt(price).toLocaleString('id-ID');
    document.getElementById('md-price-flash').innerText  = hargaFormat;
    document.getElementById('md-price-bottom').innerText = hargaFormat;
});
...
<div class="modal fade" id="modalToko" tabindex="-1">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content" style="border-radius: 0; border: none; overflow-y: auto;">
            
            <!-- Header -->
            <div style="background: linear-gradient(135deg, #8B6F4E, #D4A574); padding: 60px 20px 40px; text-align: center;">
                <button data-bs-dismiss="modal" style="position: absolute; top: 20px; left: 16px; background: rgba(255,255,255,0.2); border: none; color: white; width: 40px; height: 40px; border-radius: 50%; font-size: 1.2rem; cursor: pointer;">
                    <i class="fas fa-arrow-left"></i>
                </button>
                <div style="width: 90px; height: 90px; background: white; border-radius: 50%; margin: 0 auto 16px; display: flex; align-items: center; justify-content: center;">
                    <i class="fas fa-fire" style="font-size: 2.8rem; color: #8B6F4E;"></i>
                </div>
                <h3 style="color: white; font-weight: 800; margin: 0; font-size: 1.8rem;">Texcer Hot</h3>
                <p style="color: rgba(255,255,255,0.85); margin: 6px 0 0; font-size: 0.95rem;">Official Store</p>
            </div>

            <!-- Body -->
            <div style="padding: 24px; background: #f5f5f5; min-height: calc(100vh - 280px);">

                <!-- Rating & Penjualan -->
                <div style="background: white; border-radius: 12px; padding: 20px; display: flex; justify-content: space-around; margin-bottom: 16px;">
                    <div style="text-align: center;">
                        <div style="font-size: 1.5rem; font-weight: 800; color: #8B6F4E;">4.8</div>
                        <div style="color: #FFB800;">★★★★★</div>
                        <div style="font-size: 0.78rem; color: #999; margin-top: 4px;">Rating</div>
                    </div>
                    <div style="width: 1px; background: #f0f0f0;"></div>
                    <div style="text-align: center;">
                        <div style="font-size: 1.5rem; font-weight: 800; color: #8B6F4E;">24.6K</div>
                        <div style="font-size: 0.78rem; color: #999; margin-top: 28px;">Terjual</div>
                    </div>
                    <div style="width: 1px; background: #f0f0f0;"></div>
                    <div style="text-align: center;">
                        <div style="font-size: 1.5rem; font-weight: 800; color: #8B6F4E;">100%</div>
                        <div style="font-size: 0.78rem; color: #999; margin-top: 28px;">Respons</div>
                    </div>
                </div>

                <!-- Info Toko -->
                <div style="background: white; border-radius: 12px; padding: 20px; margin-bottom: 16px;">
                    <h5 style="font-weight: 700; margin-bottom: 16px; color: #3D2914;">Info Toko</h5>
                    <div style="display: flex; flex-direction: column; gap: 14px;">
                        <div style="display: flex; align-items: center; gap: 12px; font-size: 0.9rem;">
                            <i class="fas fa-map-marker-alt" style="color: #8B6F4E; width: 20px;"></i>
                            <span>Jl. Pedas No. 10, Semarang</span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 12px; font-size: 0.9rem;">
                            <i class="fas fa-clock" style="color: #8B6F4E; width: 20px;"></i>
                            <span>Buka: 10.00 - 22.00 WIB</span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 12px; font-size: 0.9rem;">
                            <i class="fas fa-phone" style="color: #8B6F4E; width: 20px;"></i>
                            <span>+62 812-3456-7890</span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 12px; font-size: 0.9rem;">
                            <i class="fas fa-envelope" style="color: #8B6F4E; width: 20px;"></i>
                            <span>info@texcerhot.com</span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 12px; font-size: 0.9rem;">
                            <i class="fas fa-truck" style="color: #8B6F4E; width: 20px;"></i>
                            <span>69% mengirim dalam 48 jam</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Deskripsi -->
                <div style="background: white; border-radius: 12px; padding: 20px; margin-bottom: 16px;">
                    <h5 style="font-weight: 700; margin-bottom: 12px; color: #3D2914;">Tentang Toko</h5>
                    <p style="font-size: 0.9rem; color: #666; line-height: 1.7; margin: 0;">
                        Texcer Hot adalah toko makanan pedas terpercaya yang menyajikan berbagai menu lezat mulai dari Mie Yamin, Ceker Mercon, Dimsum, hingga minuman segar. Kualitas terbaik dengan rasa autentik dan pengiriman cepat ke tempatmu!
                    </p>
                </div>

                <!-- Tombol -->
                <button onclick="document.getElementById('menu').scrollIntoView({behavior:'smooth'}); bootstrap.Modal.getInstance(document.getElementById('modalToko')).hide();"
                    style="width: 100%; background: #8B6F4E; color: white; border: none; padding: 16px; border-radius: 12px; font-weight: 700; font-size: 1rem; cursor: pointer;">
...
<script>
function showTokoModal() {
    new bootstrap.Modal(document.getElementById('modalToko')).show();
}
</script>
