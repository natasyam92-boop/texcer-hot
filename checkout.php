...
if(isset($_POST['process_order'])){
    ...
    if(!empty($_SESSION['cart'])){
        foreach($_SESSION['cart'] as $item) $total += ((int)$item['price'] * (int)$item['qty']);
        ...
        if(mysqli_query($conn, $sql_order)){
            ...
            $grand_total += ((int)$item['price'] * (int)$item['qty']);
...
<?php if(!empty($_SESSION['cart'])): ?>
    ...
    <div class="shop-group">
        ...
        <?php foreach($_SESSION['cart'] as $index => $item):
            ...
            $originalPrice = (int)$item['price'] * 1.25;
            $discount = 20;
        ?>
        <div class="cart-item" id="item-<?= $index ?>">
            ...
            <div class="item-body">
                ...
                <div class="item-price-row">
                    ...
                    <span class="item-original-price">Rp<?= number_format((float)$originalPrice, 0, ',', '.') ?></span>
